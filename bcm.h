...
#define PWM_ADDR                                                               \
  (PERIPH_BASE +                                                               \
   0x20C000) // Fonte: p.141
             // https://elinux.org/BCM2835_datasheet_errata#p142.2F143_register_table
...
#define CM_PWM_REG(X)                                                          \
  ((volatile cm_pwm_reg_t *)(CM_PWM_ADDR))                                     \
      ->X // Usando CM_PWM_ADDR = PERIPH_BASE + 0x1010a0
